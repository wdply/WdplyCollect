...
public class DrawRadarCharView extends View {
    ...
    public DrawRadarCharView(Context context) {
        super(context);

        init(context);
    }

    public DrawRadarCharView(Context context, AttributeSet attrs) {
        super(context, attrs);

        init(context);
    }

    public DrawRadarCharView(Context context, AttributeSet attrs, int defStyleAttr) {
